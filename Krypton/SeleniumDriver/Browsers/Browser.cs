...
namespace Driver.Browsers
{
    ...
    public class Browser
    {
        ...
        private static Selenium.WebDriverBackedSelenium _selenium;
        ...
        public void Wait(string time)
        {
            ...
            catch (WebDriverTimeoutException e) { Console.WriteLine(e.Message); }
        ...
        /// <returns>boolean </returns>
                ...
                try
                {
                    if ((_errorCaptureAs.ToLower().Equals("both") || _errorCaptureAs.ToLower().Equals("image")))
                    {
                        ...
                        if (screenShot != null)
                        {
                            ...
                            screenShot.SaveAsFile(path + "/" + imageNameHQ, OpenQA.Selenium.ScreenshotImageFormat.Jpeg);
                            // Compress Image
                            try
                            {
            ...
            public static Selenium.WebDriverBackedSelenium GetSeleniumOne()
            {
                if (_selenium == null)
                {
