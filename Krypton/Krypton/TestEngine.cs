          ...
          //  if (TestCases.Length > 1) Utility.SetParameter("closebrowseroncompletion", "true");
            ...
            for (int testCaseCnt = 0; testCaseCnt < TestCases.Length; testCaseCnt++)
            {
                ...
                try
                {
                    ...
                    if (Utility.GetParameter("closebrowseroncompletion").ToLower().Trim().Equals("true") || Browser.Driverlist.Count >= 1)
                    {
                        Console.WriteLine(Utility.GetParameter("closebrowseroncompletion"));
                        Console.WriteLine(Browser.Driverlist.Count);
